...
> {
  ...
  public render(): JSX.Element {
    ...
    let buttonColor = this.props.pressed
      ? Color.fromRgba(this.props.activeColor).toHex()
      : Color.fromRgba(this.props.inactiveColor).toHex();

    if (buttonColor === '#000000') buttonColor = '#7D8386';
    const styles = {
      backgroundColor: buttonColor,
      borderColor: this.props.pressed
        ? '#fff'
        : this.props.editing
        ? '#ff00ef'
        : buttonColor,
