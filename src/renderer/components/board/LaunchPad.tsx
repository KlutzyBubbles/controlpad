...
import { StateMappings, Mapping } from '@common/Interfaces';
    ...
    return (
      <div className={classes.join(' ')}>
        <TowRow
          ...
          topMappingStates={
            this.props.stateMappings !== undefined
              ? Object.prototype.hasOwnProperty.call(
                  this.props.stateMappings,
                  Section.Top,
                )
                ? this.props.stateMappings[Section.Top]
                : []
              : []
          }
        />
          ...
          mainMappingStates={
            this.props.stateMappings !== undefined
              ? Object.prototype.hasOwnProperty.call(
                ...
                ? this.props.stateMappings[Section.Main]
                : []
              : []
          }
        />
          ...
          sideMappingStates={
            this.props.stateMappings !== undefined
              ? Object.prototype.hasOwnProperty.call(
                ...
                ? this.props.stateMappings[Section.Side]
                : []
              : []
          }
        />
